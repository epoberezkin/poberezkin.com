...
Using LLMs is not optional. Competitors who adopt LLMs ship product changes at least 10x faster. Attackers already use LLMs to find vulnerabilities and exploits at scale. Not adopting LLMs for security analysis, code review, and testing is a major risk.
...
[^vibe]: Vibecoding is oxymoron. "Coding" is "codifying requirements and specification in code". People who "vibecode" do not codify anothing - they have a dialogue with LLMs and from rather incoherent conversation emerges an incoherent system, that neither vibecoder nor LLM can reason about. Nobody knows what it does beyond certain threshold.
